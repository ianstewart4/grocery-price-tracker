...
function ProductDisplay({ props }) {
    return (React.createElement("div", { className: "card lg:card-side bg-base-100 shadow-xl" },
        ...
        React.createElement("div", { className: "card-body" },
            ...
            React.createElement("p", null,
                ...
                props.packageUnits,
                ")"),
            props.salePrice && (React.createElement("p", null,
                "Sale Price: ",
                props.salePrice,
                " (",
            ...
            React.createElement("div", { className: "card-actions justify-end" },
                React.createElement("button", { className: "btn btn-primary" }, "Create Alert")))));
}
