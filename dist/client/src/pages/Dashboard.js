...
function Dashboard() {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", null,
            React.createElement("section", { className: "min-h-screen hero-overlay bg-opacity-60 pt-8" },
                !productData && (React.createElement("h1", { className: "text-center text-xl pt-10" },
                    "Welcome ",
                    user && user.name)),
                React.createElement("form", { onSubmit: handleSubmit, className: "mx-8" },
                ...
                React.createElement("p", { className: "m-8" }, "Trackers Dashboard"),
                React.createElement("h1", { className: "mx-8" }, productData && JSON.stringify(productData)),
